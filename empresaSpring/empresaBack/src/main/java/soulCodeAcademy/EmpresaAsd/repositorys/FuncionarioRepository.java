...
public interface FuncionarioRepository extends JpaRepository<Funcionario,Integer>{
	...
	@Query(value = "SELECT id_funcionario, func_nome, func_cidade, ca_nome, ca_atribuicao FROM cargo right JOIN funcionario ON funcionario.id_cargo= cargo.id_cargo", nativeQuery = true)
