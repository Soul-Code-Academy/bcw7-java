...
public interface FuncionarioRepository extends JpaRepository<Funcionario,Integer>{
	...
	@Query(value = "SELECT id_funcionario,func_foto,func_nome,func_cpf,func_nascimento,func_telefone,func_email,func_cep,func_cidade,func_bairro,func_rua,func_numero,func_referencia,func_estado,ca_nome,ca_atribuicao FROM cargo right JOIN funcionario ON funcionario.id_cargo = cargo.id_cargo order by func_nome",nativeQuery = true)
